package com.ankama.chat
{
   ...
   public final dynamic class DeleteGroup extends Message
   {
      ...
      public static const GROUP:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.DeleteGroup.group","group",1 << 3 | WireType.LENGTH_DELIMITED);
