package com.ankama.chat
{
   ...
   public final dynamic class SendInvite extends Message
   {
      ...
      public static const TOUSER:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.SendInvite.toUser","toUser",1 << 3 | WireType.LENGTH_DELIMITED);
