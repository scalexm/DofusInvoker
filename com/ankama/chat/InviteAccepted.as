package com.ankama.chat
{
   ...
   public final dynamic class InviteAccepted extends Message
   {
      ...
      public static const FROMUSER:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.InviteAccepted.fromUser","fromUser",1 << 3 | WireType.LENGTH_DELIMITED);
      
      public static const TOUSER:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.InviteAccepted.toUser","toUser",2 << 3 | WireType.LENGTH_DELIMITED);
