package com.ankama.chat
{
   ...
   public final dynamic class FriendRemoved extends Message
   {
      ...
      public static const FRIEND:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.FriendRemoved.friend","friend",1 << 3 | WireType.LENGTH_DELIMITED);
