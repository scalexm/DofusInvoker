package com.ankamagames.dofus.uiApi
{
   ...
   public class ChatApi implements IApi
   {
      ...
      [Untrusted]
      public function newChatSentenceWithSource(id:uint, msg:String, channel:uint = 0, time:Number = 0, finger:String = "", senderId:Number = 0, prefix:String = "", senderName:String = "", objects:Vector.<ItemWrapper> = null) : ChatSentenceWithSource
      {
         var csws:ChatSentenceWithSource = new ChatSentenceWithSource(id,msg,msg,channel,time,finger,senderId,prefix,senderName,objects);
         return csws;
      }
      
      [Untrusted]
      public function newChatSentenceWithRecipient(id:uint, msg:String, channel:uint = 0, time:Number = 0, finger:String = "", senderId:Number = 0, prefix:String = "", senderName:String = "", receiverName:String = "", receiverId:Number = 0, objects:Vector.<ItemWrapper> = null) : ChatSentenceWithRecipient
      {
         var cswr:ChatSentenceWithRecipient = new ChatSentenceWithRecipient(id,msg,msg,channel,time,finger,senderId,prefix,senderName,receiverName,receiverId,objects);
         return cswr;
      }
