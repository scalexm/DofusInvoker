package com.ankamagames.dofus.logic.common.managers
{
   ...
   public class NotificationManager
   {
      ...
      private var _notificationList:Vector.<Notification#241>;
      
      public function NotificationManager(pvt:PrivateClass#241)
      {
         super();
         this._notificationList = new Vector.<Notification#241>();
      }
      ...
      public static function getInstance() : NotificationManager
      {
         if(_self == null)
         {
            _self = new NotificationManager(new PrivateClass#241());
         }
         return _self;
      }
      ...
      {
         var notif:Notification = new Notification#241();
         notif.title = pTitle;
      ...
      public function sendNotification(notificationId:int = -1) : void
      {
         ...
         {
            this.openNotification(this._notificationList[notificationId] as Notification#241);
      ...
      private function getNotification(pId:uint) : Notification#241
      {
...
class PrivateClass#241
{
    
   
   function PrivateClass#241()
   {
      super();
   }
}
