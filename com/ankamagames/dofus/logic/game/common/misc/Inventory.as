package com.ankamagames.dofus.logic.game.common.misc
{
   ...
   public class Inventory
   {
      ...
      public function getItem(uid:int) : ItemWrapper
      {
         ...
         {
            return (this._itemsDict[uid] as ItemSet#476).item;
         }
         return null;
      }
      ...
      public function initializeFromObjectItems(items:Vector.<ObjectItem>) : void
      {
         ...
         for(i = 0; i < l; i++)
         {
            ...
            this._itemsDict[item.objectUID] = new ItemSet#476(iw);
            list.push(iw);
         }
      ...
      protected function addItemToViews(itemSet:ItemSet#476) : void
      {
      ...
      protected function modifyItemFromViews(itemSet:ItemSet#476, oldItem:ItemWrapper) : void
      {
         var mask:int = 0;
         var view:IInventoryView = null;
         var quantity:int = 0;
      ...
      protected function removeItemFromViews(itemSet:ItemSet#476) : void
      {
         var view:IInventoryView = null;
         for each(view in this._views)
         {
...
class ItemSet#476
{
   ...
   function ItemSet#476(iw:ItemWrapper)
   {
      super();
      this.item = iw;
   }
