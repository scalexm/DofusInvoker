package com.ankamagames.dofus.logic.game.common.frames
{
   ...
   import com.ankamagames.dofus.breach.BreachBranchWrapper;
   ...
   import com.ankamagames.dofus.network.messages.game.context.roleplay.breach.reward.BreachSaveBuyMessage;
   ...
   public class BreachFrame implements Frame
   {
      ...
      public function process(msg:Message) : Boolean
      {
         ...
         var bsbamsg:BreachSaveBuyMessage = null;
         var bsbmsg:BreachSaveBoughtMessage = null;
         ...
         switch(true)
         {
            ...
            case msg is BreachBranchesMessage:
               ...
               for each(branch in bbrespmsg.branches)
               {
                  ...
                  branches.push(new BreachBranchWrapper(branch));
               }
               KernelEventsManager.getInstance().processCallback(BreachHookList.BreachBranchesList,branches);
               return true;
            case msg is BreachInvitationRequestAction:
               ...
               birm.initBreachInvitationRequestMessage(bira.guestId);
            ...
            case msg is BreachRewardsMessage:
               ...
               KernelEventsManager.getInstance().processCallback(BreachHookList.OpenBreachShop,brrmsg.save,rewards);
               return true;
            case msg is BreachSaveBuyAction:
               bsbamsg = new BreachSaveBuyMessage();
               bsbamsg.initBreachSaveBuyMessage();
               ConnectionsHandler.getConnection().send(bsbamsg);
               return true;
            case msg is BreachSaveBoughtMessage:
               bsbmsg = msg as BreachSaveBoughtMessage;
               KernelEventsManager.getInstance().processCallback(BreachHookList.BreachSaveBought,bsbmsg.bought);
               return true;
