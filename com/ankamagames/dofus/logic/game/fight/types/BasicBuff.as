package com.ankamagames.dofus.logic.game.fight.types
{
   ...
   public class BasicBuff
   {
      ...
      public function equals(other:BasicBuff, ignoreSpell:Boolean = false) : Boolean
      {
         ...
         else if(this.actionId == ActionIds.ACTION_BOOST_SPELL_RANGE || this.actionId == ActionIds.ACTION_BOOST_SPELL_RANGEABLE || this.actionId == ActionIds.ACTION_BOOST_SPELL_DMG || this.actionId == ActionIds.ACTION_BOOST_SPELL_HEAL || this.actionId == ActionIds.ACTION_BOOST_SPELL_AP_COST || this.actionId == ActionIds.ACTION_BOOST_SPELL_CAST_INTVL || this.actionId == ActionIds.ACTION_BOOST_SPELL_CC || this.actionId == ActionIds.ACTION_BOOST_SPELL_CASTOUTLINE || this.actionId == ActionIds.ACTION_BOOST_SPELL_NOLINEOFSIGHT || this.actionId == ActionIds.ACTION_BOOST_SPELL_MAXPERTURN || this.actionId == ActionIds.ACTION_BOOST_SPELL_MAXPERTARGET || this.actionId == ActionIds.ACTION_BOOST_SPELL_CAST_INTVL_SET || this.actionId == ActionIds.ACTION_BOOST_SPELL_BASE_DMG || this.actionId == ActionIds.ACTION_DEBOOST_SPELL_RANGE || this.actionId == ActionIds.ACTION_CHARACTER_DISPELL_SPELL || this.actionId == ActionIds.ACTION_TARGET_EXECUTE_SPELL || this.actionId == ActionIds.ACTION_TARGET_EXECUTE_SPELL_WITH_ANIMATION || this.actionId == ActionIds.ACTION_TARGET_EXECUTE_SPELL_ON_SOURCE || this.actionId == ActionIds.ACTION_SOURCE_EXECUTE_SPELL_ON_TARGET || this.actionId == ActionIds.ACTION_SOURCE_EXECUTE_SPELL_ON_SOURCE || this.actionId == ActionIds.ACTION_CHARACTER_ADD_SPELL_COOLDOWN || this.actionId == ActionIds.ACTION_CHARACTER_REMOVE_SPELL_COOLDOWN || this.actionId == ActionIds.ACTION_CHARACTER_PROTECTION_FROM_SPELL || this.actionId == ActionIds.ACTION_CHARACTER_SET_SPELL_COOLDOWN)
         {
            if(this.param1 != other.param1)
            {
               return false;
      ...
      public function add(buff:BasicBuff) : void
      {
         ...
         switch(this.actionId)
         {
            ...
            case ActionIds.ACTION_BOOST_SPELL_RANGE:
            ...
            case ActionIds.ACTION_DEBOOST_SPELL_RANGE:
