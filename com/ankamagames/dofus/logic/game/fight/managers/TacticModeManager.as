package com.ankamagames.dofus.logic.game.fight.managers
{
   ...
   public class TacticModeManager
   {
      ...
      public function TacticModeManager(pvt:PrivateClass#305)
      {
      ...
      public static function getInstance() : TacticModeManager
      {
         if(_self == null)
         {
            _self = new TacticModeManager(new PrivateClass#305());
         }
         return _self;
      }
      ...
      public function show(pPoint:WorldPointWrapper, openByTerminal:Boolean = false) : void
      {
         ...
         if(useNewTacticalMode)
         {
            ...
            this._templateToShow = OptionManager.getOptionManager("dofus")["forceDefaultTacticalModeTemplate"] == true?uint(1):uint(Math.max(templateId,1));
...
class PrivateClass#305
{
    
   
   function PrivateClass#305()
   {
      super();
   }
}
