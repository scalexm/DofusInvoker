package com.ankamagames.dofus.externalnotification
{
   ...
   public class ExternalNotificationManager
   {
      ...
      public function ExternalNotificationManager(pc:PrivateClass#151)
      {
      ...
      public static function getInstance() : ExternalNotificationManager
      {
         if(!_instance)
         {
            _instance = new ExternalNotificationManager(new PrivateClass#151());
         }
         return _instance;
      }
      ...
      public function init() : void
      {
         ...
         var x:XML = DescribeTypeCache.typeDescription(ExternalNotificationTypeEnum);
...
class PrivateClass#151
{
    
   
   function PrivateClass#151()
   {
      super();
   }
}
