package com.ankamagames.dofus.network.types.game.context.roleplay
{
   ...
   public class GameRolePlayNamedActorInformations extends GameRolePlayActorInformations implements INetworkType
   {
      ...
      public function initGameRolePlayNamedActorInformations(contextualId:Number = 0, look:EntityLook = null, disposition:EntityDispositionInformations = null, name:String = "") : GameRolePlayNamedActorInformations
      {
