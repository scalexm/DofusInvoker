package com.ankamagames.dofus.network.types.game.context.fight
{
   ...
   public class GameFightEntityInformation extends GameFightFighterInformations implements INetworkType
   {
      ...
      public function initGameFightEntityInformation(contextualId:Number = 0, look:EntityLook = null, disposition:EntityDispositionInformations = null, teamId:uint = 2, wave:uint = 0, alive:Boolean = false, stats:GameFightMinimalStats = null, previousPositions:Vector.<uint> = null, entityModelId:uint = 0, level:uint = 0, masterId:Number = 0) : GameFightEntityInformation
      {
