package com.ankamagames.dofus.network.types.game.context.fight
{
   ...
   public class GameFightCharacterInformations extends GameFightFighterNamedInformations implements INetworkType
   {
      ...
      public function initGameFightCharacterInformations(contextualId:Number = 0, look:EntityLook = null, disposition:EntityDispositionInformations = null, teamId:uint = 2, wave:uint = 0, alive:Boolean = false, stats:GameFightMinimalStats = null, previousPositions:Vector.<uint> = null, name:String = "", status:PlayerStatus = null, leagueId:int = 0, ladderPosition:int = 0, hiddenInPrefight:Boolean = false, level:uint = 0, alignmentInfos:ActorAlignmentInformations = null, breed:int = 0, sex:Boolean = false) : GameFightCharacterInformations
      {
