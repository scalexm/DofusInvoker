package com.ankamagames.dofus.network.types.game.context.fight
{
   ...
   public class GameFightFighterNamedInformations extends GameFightFighterInformations implements INetworkType
   {
      ...
      public function initGameFightFighterNamedInformations(contextualId:Number = 0, look:EntityLook = null, disposition:EntityDispositionInformations = null, teamId:uint = 2, wave:uint = 0, alive:Boolean = false, stats:GameFightMinimalStats = null, previousPositions:Vector.<uint> = null, name:String = "", status:PlayerStatus = null, leagueId:int = 0, ladderPosition:int = 0, hiddenInPrefight:Boolean = false) : GameFightFighterNamedInformations
      {
