package com.ankamagames.dofus.network.messages.game.inventory.exchanges
{
   ...
   public class ExchangeCraftInformationObjectMessage extends ExchangeCraftResultWithObjectIdMessage implements INetworkMessage
   {
      ...
      public function initExchangeCraftInformationObjectMessage(craftResult:uint = 0, objectGenericId:uint = 0, playerId:Number = 0) : ExchangeCraftInformationObjectMessage
      {
      ...
      public function deserializeAsyncAs_ExchangeCraftInformationObjectMessage(tree:FuncTree) : void
      {
