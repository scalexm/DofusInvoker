package com.ankamagames.dofus.network.messages.game.context.roleplay.breach.reward
{
   ...
   public class BreachRewardsMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public var save:BreachReward;
      
      private var _rewardstree:FuncTree;
      
      private var _savetree:FuncTree;
      ...
      public function initBreachRewardsMessage(rewards:Vector.<BreachReward> = null, save:BreachReward = null) : BreachRewardsMessage
      {
      ...
      public function serializeAs_BreachRewardsMessage(output:ICustomDataOutput) : void
      {
         ...
         this.save.serializeAs_BreachReward(output);
      }
      ...
      public function deserializeAsyncAs_BreachRewardsMessage(tree:FuncTree) : void
      {
         ...
         this._savetree = tree.addChild(this._savetreeFunc);
      }
      ...
      private function _savetreeFunc(input:ICustomDataInput) : void
      {
         this.save = new BreachReward();
         this.save.deserializeAsync(this._savetree);
      }
   }
}
