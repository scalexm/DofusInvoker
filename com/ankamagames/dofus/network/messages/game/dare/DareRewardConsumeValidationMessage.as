package com.ankamagames.dofus.network.messages.game.dare
{
   ...
   public class DareRewardConsumeValidationMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function initDareRewardConsumeValidationMessage(dareId:Number = 0, type:uint = 0) : DareRewardConsumeValidationMessage
      {
         this.dareId = dareId;
         this.type = type;
      ...
      {
         this.serializeAs_DareRewardConsumeValidationMessage(output);
      }
      
      public function serializeAs_DareRewardConsumeValidationMessage(output:ICustomDataOutput) : void
      {
      ...
      {
         this.deserializeAs_DareRewardConsumeValidationMessage(input);
      }
      
      public function deserializeAs_DareRewardConsumeValidationMessage(input:ICustomDataInput) : void
      {
      ...
      {
         this.deserializeAsyncAs_DareRewardConsumeValidationMessage(tree);
      }
      
      public function deserializeAsyncAs_DareRewardConsumeValidationMessage(tree:FuncTree) : void
      {
