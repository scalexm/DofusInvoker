package com.ankamagames.dofus.misc.utils
{
   ...
   public class Inspector
   {
      ...
      private var _lastTarget:Vector.<InteractiveItem#510>;
      
      private var _currentShortCut:Vector.<ShortcutItem#510>;
      ...
      private function onMouseMove(e:MouseEvent) : void
      {
         ...
         if(this._lastTarget.length)
         {
            ...
            this._currentShortCut = !!this._lastTarget[0].shortcuts?this._lastTarget[0].shortcuts.concat():new Vector.<ShortcutItem#510>();
            this._currentShortCut.unshift(new ShortcutItem#510("Copier toutes les informations",Keyboard.C,function():void
            {
               var tf:* = new TextField();
               tf.htmlText = rawTooltipStr.split("<br/>").join("\n");
               Clipboard.generalClipboard.setData(ClipboardFormats.TEXT_FORMAT,tf.text);
            },true,false,false));
            this._currentShortCut.unshift(new ShortcutItem#510("Activer l\'inspection avancée",Keyboard.Z,function():void
            {
      ...
      private function findElements(target:DisplayObject) : Vector.<InteractiveItem#510>
      {
         var currentItem:InteractiveItem = null;
         var result:Vector.<InteractiveItem> = new Vector.<InteractiveItem#510>();
         var ind:String = "";
      ...
      private function findSameLevelElements() : Vector.<InteractiveItem#510>
      {
         var currentItem:InteractiveItem = null;
         var item:DisplayObject = null;
         var result:Vector.<InteractiveItem> = new Vector.<InteractiveItem#510>();
      ...
      private function cast(target:DisplayObject) : InteractiveItem#510
      {
         var currentItem:InteractiveItem = null;
         switch(true)
         {
            ...
            case target is GraphicContainer:
               currentItem = new InteractiveItemUi#510();
      ...
      private function changeInteraction(target:DisplayObjectContainer) : void
      {
         ...
         for(var i:uint = 0; i < target.numChildren; )
         {
...
class ShortcutItem#510
{
   ...
   function ShortcutItem#510(legend:String, key:uint, callback:Function, ctrl:Boolean, shift:Boolean, alt:Boolean)
   {
      super();
      this.legend = legend;
      this.key = key;
...
class InteractiveItem#510
{
   ...
   public var shortcuts:Vector.<ShortcutItem#510>;
   
   public var target:DisplayObject;
   
   function InteractiveItem#510()
   {
      super();
   }
   
   public function highlight(index:uint, elements:Vector.<InteractiveItem#510>) : void
   {
   }
...
class InteractiveItemUi#510 extends InteractiveItem#510
{
    
   
   function InteractiveItemUi#510()
   {
      super();
      shortcuts = Vector.<ShortcutItem#510>([new ShortcutItem#510("Cmd click test fonctionnel",Keyboard.Q,function():void
      {
         toClipboard("click( UiHelper.get(\"" + GraphicContainer(target).getUi().uiData.name + "\"), \"" + GraphicContainer(target).customUnicName + "\");");
      },true,true,false),new ShortcutItem#510("Cmd son survol",Keyboard.S,function():void
      {
      ...
      },true,true,false),new ShortcutItem#510("Cmd son click",Keyboard.X,function():void
      {
         toClipboard("/adduisoundelement " + GraphicContainer(target).getUi().uiData.name + " " + target.name + " onRelease [ID_SON]");
      },true,true,false),new ShortcutItem#510("Cmd inspecter element",Keyboard.A,function():void
      {
         toClipboard("/inspectuielement " + GraphicContainer(target).getUi().uiData.name + " " + target.name);
      },true,true,false)]);
   }
   
   override public function highlight(index:uint, elements:Vector.<InteractiveItem#510>) : void
   {
      ...
      for each(elem in elements)
      {
         ...
         if(elem is InteractiveItemUi#510 && elem.target != target)
         {
            firstUi = false;
            break;
         }
...
class InteractiveItemCell extends InteractiveItem#510
{
...
class InteractiveItemEntity extends InteractiveItem#510
{
      ...
      if(info)
      {
         switch(true)
         {
            case info is GameRolePlayNpcInformations:
               ...
               shortcuts.push(new ShortcutItem#510("Ouvrir l\'admin lite de ce PNJ",Keyboard.A,function():void
               {
...
class InteractiveItemElement extends InteractiveItem#510
{
...
class InteractiveItemMapBorder extends InteractiveItem#510
{
