package com.ankamagames.dofus.misc.utils
{
   ...
   public class SubhintInspector
   {
      ...
      private var _lastTarget:Vector.<InteractiveItem#181>;
      
      private var _underPoint:Point;
      
      private var _currentShortCut:ShortcutItem#181;
      ...
      private function onMouseMove(e:MouseEvent) : void
      {
         ...
         {
            this._currentShortCut = new ShortcutItem#181("Freeze",Keyboard.S,this.freeze,true);
         }
      ...
      private function findElements(target:DisplayObject) : Vector.<InteractiveItem#181>
      {
      ...
      private function cast(target:DisplayObject) : InteractiveItem#181
      {
         var currentItem:InteractiveItem = null;
         switch(true)
         {
            ...
            case target is GraphicContainer:
               currentItem = new InteractiveItemUi#181();
...
class ShortcutItem#181
{
   ...
   function ShortcutItem#181(legend:String, key:uint, callback:Function, shift:Boolean)
   {
      super();
      this.legend = legend;
      this.key = key;
...
class InteractiveItem#181
{
   ...
   public var shortcut:ShortcutItem#181;
...
class InteractiveItemUi#181 extends InteractiveItem#181
{
    
   
   function InteractiveItemUi#181()
   {
      super();
   }
