package com.ankamagames.berilia.components
{
   ...
   public class ChatComponent extends GraphicContainer implements UIComponent, IRectangle, FinalizableUIComponent
   {
      ...
      private var _smilies:Vector.<Smiley#489>;
      ...
      public function initSmileyTab(uri:String, data:Object) : void
      {
         ...
         this._smilies = new Vector.<Smiley#489>();
         for each(t in data)
         {
            if(t.triggers != null && t.triggers.length > 0)
            {
               smiley = new Smiley#489(t.gfxId);
      ...
      private function getSmileyFromText(sTxt:String) : Smiley#489
      {
...
class Smiley#489
{
   ...
   function Smiley#489(pId:String)
   {
      super();
      this.pictoId = pId;
      this.position = -1;
