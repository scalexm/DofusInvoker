package com.ankamagames.berilia.components
{
   ...
   public class TextAreaInput extends TextArea implements FinalizableUIComponent
   {
      ...
      private var _inputHistory:Vector.<InputEntry#6600>;
      ...
      public function TextAreaInput()
      {
         ...
         this._inputHistory = new Vector.<InputEntry#6600>(0);
      ...
      private function addHistory(pText:String) : void
      {
         ...
         var entry:InputEntry = new InputEntry#6600(pText,hyperlinkCodes);
...
class InputEntry#6600
{
   ...
   function InputEntry#6600(pText:String, pHyperlinkCodes:Vector.<String>)
   {
      super();
      this._text = pText;
