package flashx.textLayout.compose
{
   ...
   public class Parcel
   {
      ...
      private static var edgeCache:Vector.<Edge#532>;
      ...
      private var _left:Edge#532;
      
      private var _right:Edge#532;
      ...
      private function allocateEdge(x:Number) : Edge#532
      {
         if(!edgeCache)
         {
            edgeCache = new Vector.<Edge#532>();
         }
         var edge:Edge = edgeCache.length > 0?edgeCache.pop():new Edge#532();
         edge.initialize(x);
         return edge;
      }
      
      private function deallocateEdge(edge:Edge#532) : void
      {
