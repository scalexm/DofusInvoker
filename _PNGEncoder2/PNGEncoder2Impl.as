package _PNGEncoder2
{
   ...
   public class PNGEncoder2Impl
   {
      ...
      public static function writeIHDRChunk(param1:BitmapData, param2:ByteArray) : void
      {
         ...
         var _loc10_:* = 0;
         var _loc11_:* = 0;
         var _loc4_:Number = Number(Math.max(6600 + 13,ApplicationDomain.MIN_DOMAIN_MEMORY_LENGTH));
         ...
         si8(0,6611);
         si8(0,6612);
         param2.writeUnsignedInt(13);
         param2.writeUnsignedInt(1229472850);
         PNGEncoder2Impl.data.position = 6600;
         PNGEncoder2Impl.data.readBytes(param2,param2.position,13);
         param2.position = uint(param2.position + 13);
         var _loc7_:* = -1;
