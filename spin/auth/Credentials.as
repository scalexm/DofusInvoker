package spin.auth
{
   ...
   public final dynamic class Credentials extends Message
   {
      ...
      public static const UID:String = "9C93255C-980C-4B05-8256-D2C286F5FC3B";
      
      public static const PASSWORD:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("spin.auth.Credentials.password","password",1 << 3 | WireType.LENGTH_DELIMITED);
      ...
      override final function writeToBuffer(output:WritingBuffer) : void
      {
         ...
         WriteUtils.write_TYPE_STRING(output,this.password);
