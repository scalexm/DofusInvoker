package spin.proxy
{
   ...
   public final dynamic class Pong extends Message
   {
      
      public static const UID:String = "A63EBC14-ACEC-4841-B781-E48FCACB32D3";
      
      public static const TIMESTAMP:FieldDescriptor_TYPE_FIXED64 = new FieldDescriptor_TYPE_FIXED64("spin.proxy.Pong.timestamp","timestamp",1 << 3 | WireType.FIXED_64_BIT);
      
      public static const ID:FieldDescriptor_TYPE_FIXED64 = new FieldDescriptor_TYPE_FIXED64("spin.proxy.Pong.id","id",2 << 3 | WireType.FIXED_64_BIT);
         ...
         while(input.bytesAvailable > bytesAfterSlice)
         {
            ...
            switch(tag >> 3)
            {
               case 1:
                  ...
                  {
                     throw new IOError("Bad data format: Pong.timestamp cannot be set twice.");
                  }
                  timestamp$count++;
               ...
               case 2:
                  if(id$count != 0)
                  {
                     throw new IOError("Bad data format: Pong.id cannot be set twice.");
                  }
                  id$count++;
