package damageCalculation.spellManagement
{
   ...
   public class HaxeSpellEffect
   {
      ...
      {
         var _loc1_:HaxeSpellEffect = new HaxeSpellEffect(id,level,order,actionId,param1,param2,param3,duration,isCritical,"",rawZone,mask,randomWeight,randomGroup,isDispellable,delay,category);
