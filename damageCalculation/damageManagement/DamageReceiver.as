package damageCalculation.damageManagement
{
   ...
   public class DamageReceiver
   {
      ...
      public static function receiveDamageOrHeal(param1:FightContext, param2:RunningEffect, param3:DamageRange, param4:HaxeFighter, param5:Boolean = false, param6:Boolean = false) : Array
      {
         ...
         var _loc8_:Array = [];
         if(_loc7_.isCollision || ActionIdHelper.isFakeDamage(param2.getSpellEffect().actionId))
         {
         ...
         else
         {
            ...
            if(_loc9_ > 0 && !_loc7_.isHeal && !param4.isInvulnerableTo(param2,param5))
            {
               _loc7_.isHeal = true;
         ...
         while(_loc9_ < int(_loc10_.length))
         {
            ...
            while(_loc13_ < int(_loc8_.length))
            {
               ...
               _loc13_++;
               if(_loc14_.fighterId == _loc11_ && _loc14_.damageRange != null && !_loc14_.damageRange.isInvulnerable && !_loc14_.damageRange.isZero() && !_loc14_.damageRange.isShieldDamage)
               {
      ...
      public static function receiveDamage(param1:FightContext, param2:RunningEffect, param3:DamageRange, param4:HaxeFighter, param5:Boolean = false, param6:Boolean = false) : Array
      {
         ...
         param4.lastRawDamageTaken = param3.copy();
         param3.add(-int(DamageReceiver.getFlatResistance(param2,param4)));
         ...
         param3.multiply(1 - int(param4.getElementMainResist(int(ElementEnum.getElementFromActionId(param2.getSpellEffect().actionId)))) / 100);
         param3.minimizeBy(0);
         var _loc12_:Array = DamageReceiver.getSplitDamages(param1,param2,param3,param4,param6);
         if(_loc12_ != null)
         {
      ...
      public static function changeTargetIfSacrifice(param1:FightContext, param2:RunningEffect, param3:EffectOutput, param4:HaxeFighter, param5:Boolean) : Number
      {
         ...
         if(param2.getSpellEffect().actionId != 80 && !param4.isInvulnerableTo(param2,param5))
         {
      ...
      {
         if(param2.isInvulnerableTo(param1,param4))
         {
            param3.isInvulnerable = true;
         }
         param3.minimizeBy(0);
         if(param1.getSpellEffect().actionId != 80)
         {
      ...
      public static function applyDealtMultiplier(param1:RunningEffect, param2:DamageRange, param3:HaxeFighter, param4:Boolean = false) : DamageRange
      {
         ...
         param2.multiply(int(param3.getDamageMultiplicator(param1,param4)) / 100);
         return param2;
      }
      ...
      public static function reflectDamages(param1:FightContext, param2:RunningEffect, param3:DamageRange, param4:HaxeFighter) : DamageRange
      {
         ...
         if(!_loc8_.isZero())
         {
            ...
            _loc10_ = param4.getElementMainResist(int(ElementEnum.getElementFromActionId(param2.getSpellEffect().actionId)));
      ...
      public static function getFlatResistance(param1:RunningEffect, param2:HaxeFighter) : int
      {
         var _loc3_:HaxeSpellEffect = param1.getSpellEffect();
         var _loc4_:Boolean = param1.getSpellEffect().isCritical;
         var _loc5_:* = 0;
         if(!!_loc4_ && int(param1.getSpell().getEffects().indexOf(param1.getSpellEffect())) == -1)
         {
            _loc5_ = _loc5_ + int(param2.getCharacteristicValue("criticalDamageReduction"));
         }
         _loc5_ = _loc5_ + int(param2.getElementMainReduction(int(ElementEnum.getElementFromActionId(_loc3_.actionId))));
         return _loc5_;
      }
      ...
      public static function getLifeStealEffect(param1:DamageRange, param2:HaxeFighter) : EffectOutput
      {
         ...
         if(!param1.isZero() && !param1.isInvulnerable)
         {
            param1.multiply(0.5);
            _loc4_ = DamageReceiver.executeLifePointsWin(param1,param2);
            if(!_loc4_.damageRange.isZero())
            {
               _loc3_ = _loc4_;
            }
         }
