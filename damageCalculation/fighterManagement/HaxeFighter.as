package damageCalculation.fighterManagement
{
   ...
   public class HaxeFighter
   {
      ...
      public var isAppearing:Boolean;
      ...
      public function isInvulnerableTo(param1:RunningEffect, param2:Boolean = false) : Boolean
      {
         var _loc3_:HaxeSpellEffect = param1.getSpellEffect();
         var _loc4_:HaxeFighter = param1.getCaster();
         if(hasStateEffect(7) || !!hasStateEffect(27) && _loc3_.isCritical || !!hasStateEffect(28) && param1.getSpell().isWeapon || !!hasStateEffect(31) && _loc4_ != null && _loc4_.data.isSummon() || !!hasStateEffect(26) && _loc3_.actionId == 80 || !!hasStateEffect(25) && int(ElementEnum.getElementFromActionId(_loc3_.actionId)) == 0 || !!hasStateEffect(24) && int(ElementEnum.getElementFromActionId(_loc3_.actionId)) == 1 || !!hasStateEffect(23) && int(ElementEnum.getElementFromActionId(_loc3_.actionId)) == 3 || !!hasStateEffect(21) && int(ElementEnum.getElementFromActionId(_loc3_.actionId)) == 2 || !!hasStateEffect(22) && int(ElementEnum.getElementFromActionId(_loc3_.actionId)) == 4 || !!hasStateEffect(19) && param2 || !!hasStateEffect(20) && !param2)
         {
            return true;
         }
         return false;
      ...
      public function hasState(param1:int) : Boolean
      {
         ...
         while(_loc4_ != null)
         {
            ...
            _loc6_ = _loc5_;
            _loc7_ = _loc6_.item;
            if(_loc7_.effect.actionId == 950 && _loc7_.effect.param3 == param1 && SpellManager.isInstantaneousSpellEffect(_loc7_.effect))
            {
               _loc2_ = true;
            }
      ...
      public function getHealOnDamageRatio(param1:RunningEffect, param2:Boolean) : int
      {
         ...
         while(_loc3_ != null)
         {
            ...
            _loc5_ = _loc4_;
            _loc6_ = _loc5_.item;
            if(_loc6_.effect.actionId == 1164 && (SpellManager.isInstantaneousSpellEffect(_loc6_.effect) || _loc6_.shouldBeTriggeredOnTargetDamage(param1,this,param2)))
            {
      ...
      public function getDamageReductor(param1:RunningEffect, param2:DamageRange, param3:Boolean) : Interval
      {
         ...
         if(ActionIdHelper.canTriggerDamageMultiplier(param1.getSpellEffect().actionId))
         {
            ...
            while(_loc5_ != null)
            {
               ...
               _loc7_ = _loc6_;
               _loc8_ = _loc7_.item;
               if(_loc8_.effect.actionId == 265 && (SpellManager.isInstantaneousSpellEffect(_loc8_.effect) || _loc8_.shouldBeTriggeredOnTargetDamage(param1,this,param3)))
               {
      ...
      public function getDamageMultiplicator(param1:RunningEffect, param2:Boolean) : int
      {
         var _loc4_:* = null as LinkedListNode;
         var _loc5_:* = null as LinkedListNode;
         var _loc6_:* = null as LinkedListNode;
         ...
         if(ActionIdHelper.canTriggerDamageMultiplier(param1.getSpellEffect().actionId))
         {
            ...
            while(_loc4_ != null)
            {
               ...
               _loc6_ = _loc5_;
               _loc7_ = _loc6_.item;
               if(_loc7_.effect.actionId == 1163 && (SpellManager.isInstantaneousSpellEffect(_loc7_.effect) || _loc7_.shouldBeTriggeredOnTargetDamage(param1,this,param2)))
               {
                  _loc3_ = _loc3_ * _loc7_.effect.param1 * 0.01;
               }
            }
         }
         return _loc3_;
      ...
      public function getCharacteristicValue(param1:String) : int
      {
         ...
         var _loc3_:* = getBuffStatBoost(param1);
         var _loc4_:int = getBuffStatBoostPercent(param1);
         if(_loc3_.isFlat)
         {
            _loc2_ = _loc2_ + int(_loc3_.value);
         }
         else if(_loc2_ == 0)
         {
            _loc2_ = int(_loc3_.value);
         }
         else
         {
            _loc2_ = int(Math.floor(_loc2_ * (1 + int(_loc3_.value) * 0.01)));
         }
         if(_loc2_ != 0)
         {
      ...
      public function getBuffStatBoostPercent(param1:String) : int
      {
         ...
         var _loc6_:* = null as LinkedListNode;
         var _loc7_:* = null as HaxeBuff;
         var _loc2_:* = ActionIdHelper.StatToBuffPercentActionIds(param1);
         if(int(_loc2_.buffId) == -1 && int(_loc2_.debuffId) == -1)
         {
            return 0;
         }
         var _loc3_:* = 100;
         ...
         while(_loc4_ != null)
         {
            ...
            _loc6_ = _loc5_;
            _loc7_ = _loc6_.item;
            if(SpellManager.isInstantaneousSpellEffect(_loc7_.effect))
            {
               if(_loc7_.effect.actionId == int(_loc2_.buffId))
               {
                  _loc3_ = int(Math.floor(_loc3_ * (1 + int(_loc7_.effect.getMinRoll()) * 0.01)));
               }
               else if(_loc7_.effect.actionId == int(_loc2_.debuffId))
               {
                  _loc3_ = int(Math.floor(_loc3_ * (1 - int(_loc7_.effect.getMinRoll()) * 0.01)));
               }
            }
      ...
      public function getBuffStatBoost(param1:String) : Object
      {
         var _loc4_:* = null as LinkedListNode;
         var _loc5_:* = null as LinkedListNode;
         var _loc6_:* = null as LinkedListNode;
         var _loc7_:* = null as HaxeBuff;
         var _loc2_:* = ActionIdHelper.StatToBuffActionIds(param1);
         var _loc3_:* = 0;
         if(_loc2_.isLinear)
         {
            _loc4_ = _buffs.head;
            while(_loc4_ != null)
            {
               ...
               if(SpellManager.isInstantaneousSpellEffect(_loc7_.effect))
               {
                  if(_loc7_.effect.actionId == int(_loc2_.buffId))
                  {
                     _loc3_ = _loc3_ + int(_loc7_.effect.getMinRoll());
                  }
                  else if(_loc7_.effect.actionId == int(_loc2_.debuffId))
                  {
                     _loc3_ = _loc3_ - int(_loc7_.effect.getMinRoll());
         ...
         return {
            "value":_loc3_,
            "isFlat":Boolean(_loc2_.isLinear)
         };
      }
      ...
      public function getAllSacrificed() : Array
      {
         ...
         while(_loc2_ != null)
         {
            ...
            _loc4_ = _loc3_;
            _loc5_ = _loc4_.item;
            if(_loc5_.effect.actionId == 765)
            {
               _loc1_.push(_loc5_.casterId);
            }
         }
         return _loc1_;
      }
      ...
      public function canSwitchPosition(param1:int = -1) : Boolean
      {
         if(!hasStateEffect(3) && !hasStateEffect(18) && !hasState(3) && !hasState(8))
         {
